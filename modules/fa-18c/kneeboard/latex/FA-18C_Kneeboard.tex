...
\begin{itemize}
 ...
 \end{itemize}
 \item[\ri] BLEED AIR knob (\ok{RPM\;>\;60\%})\dotfill\button{$\mathbf{\circlearrowright}$\;360\textdegree}
 %\item[\ri] BLEED AIR knob (\ok{RPM\;>\;60\%})\dotfill\button{$\mathbf{\curvearrowright}$\;360\textdegree} 
\end{itemize}
 % ---------------------------------------------------------------------------------------------------
\newpage
% ENGINE START
...
\begin{itemize}
 ...
 \item[\mi] T/O TRIM button\dotfill\button{DEPRESS}
 \begin{itemize}
  \item[\yi] FCS page: Stabilator\dotfill\ok{$\mathbf{\uparrow}$\,12\textdegree}/\boat{16\textdegree-19\textdegree}
 \end{itemize}
 \item Four down test:
 \begin{itemize}
...
\begin{itemize}
 ...
 %\item[\ni] Radar altimeter low alt warning system\dotfill\button{CHECK/SET}
