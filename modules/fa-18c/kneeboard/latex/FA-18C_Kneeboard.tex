...
\begin{itemize}
 ...
 \begin{itemize}
  \item APU READY light\dotfill\ok{GREEN}
 \end{itemize}
 \item[\ri] OBOGS switch\dotfill\button{ON}
 \item[\ri] ENG CRANK switch\dotfill\button{RIGHT POS}
 \item[\ri] Right throttle (\ok{RPM\;>\;16\%})\dotfill\button{IDLE}
 \item[\ri] L/R-DDIs, MPCD and HUD\dotfill\button{ON}
 \item[\ri] COMM\;1 \& COMM\;2 radios\dotfill\button{AS REQUIRED}
 \item[\ri] RADAR knob\dotfill\button{OPER}
 \item[\ri] INS knob\dotfill\button{GND}/\boat{CV} 
 \item[\ri] ANTI SKID switch\dotfill\button{ON}/\boat{OFF}
 \item[\ri] L-DDI: select page\dotfill\button{FCS}
 \item[\ri] R-DDI: BIT page\dotfill\button{OSB STOP}
 \item[\ri] ENG CRANK switch\dotfill\button{LEFT POS}
 \item[\ri] Left throttle (\ok{RPM\;>\;16\%})\dotfill\button{IDLE}
 \item[\ri] Canopy\dotfill\button{CLOSE}
 \item[\ri] FLAP switch\dotfill\button{HALF}
 \item[\ri] T/O TRIM button\dotfill\button{DEPRESS}
 \item[\ri] FCS RESET button\dotfill\button{DEPRESS}
 \item[\ri] Standby ADI\dotfill\button{UNCAGE}
 \item[\ri] RADAR altimeter\dotfill\button{450}/\boat{370}\button{\;ft}
 \item[\ri] BINGO fuel\dotfill\button{AS REQUIRED}
 \item[\ri] L/R-DDIs:\,select pages\dotfill\button{CHECKLIST\,/\,FCS}
 \item[\ri] INS knob (\ok{alignment complete})\dotfill\button{NAV}
 \item[\ri] Parking brake\dotfill\button{RELEASE}
